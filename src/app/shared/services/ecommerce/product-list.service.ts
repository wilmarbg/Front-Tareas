...
function matches(ticket: productListInterface, term: string, pipe: PipeTransform) {
    return ticket.productName.toLowerCase().includes(term.toLowerCase())
        ...
        || ticket.stock.toLowerCase().includes(term.toLowerCase())
        || pipe.transform(ticket.amount).includes(term)
        || ticket.productImg.toLowerCase().includes(term.toLowerCase())
        || ticket.productSubName.toLowerCase().includes(term.toLowerCase())
